...
CREATE procedure InsertSP(@TICKETNUMBER nvarchar(50) ,@PASSENGERNAME nvarchar(50),@PHNUMBER bigint,@EMAILID nvarchar(50),@JOURNEYDATE datetime2(7) )
AS
BEGIN
...
--update
create procedure UpdateSP (@PASSENGERID bigint ,@TICKETNUMBER varchar(50) ,@PASSENGERNAME nvarchar(50),@PHNUMBER bigint,@EMAILID nvarchar(50),@JOURNEYDATE datetime2(7))
as
begin
update ETicket 
...
exec UpdateSP 1 ,'123','mary',3456234567,'qwer@gmail.com','05/04/2013'
